...
// Purpose: A math quiz with addition, subtraction, multiplication, and division (added for Question #1 for Unit Test #1)
// Restrictions: N/A
static class Program
{
    ...
    static void Main()
    {
        ...
        // operands and solution (made into doubles for division)
        double val1 = 0;
        double val2 = 0;
        double dAnswer = 0;
    ...
    start:
        ...
        for (nCntr = 0; nCntr < nQuestions; ++nCntr)
        {
            ...
            // else, division (user answer must be to 2 decimal places)
            if (nOp == 0)
            {
                dAnswer = val1 + val2;
            ...
            else
            {
                ...
                sQuestions = $"Question #{nCntr + 1}: {val1} / {val2} (Please enter your answer to 2 decimal places) => ";
            }
