            ...
            while (sAction != "quit")
            {
                ...
                switch (sAction)
                {
                    ...
                    case "edit":
                        ...
                        // using the indexer property to fetch the Person object from the People class
                        person = people[email];
        ...
        public static void EditPerson(ref Person thisPerson)
        {
            ...
            if (thisPerson.GetType() == typeof(Student))
            {
                ...
                do
                {
                    ...
                    thisStudent.CourseList.Add(inputString);
            ...
            if (thisPerson.GetType() == typeof(Teacher))
            {
                ...
                do
                {
                    thisTeacher.CourseList.Add(inputString);
                } while (inputString.Length > 0);
            }
        }
